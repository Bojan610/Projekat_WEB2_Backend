...
namespace UserAdminAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<UsersDbContext>(options => options.UseMySql(Configuration.GetConnectionString("UsersDatabase"), ServerVersion.AutoDetect(Configuration.GetConnectionString("UsersDatabase"))));
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "UserAdminAPI v1"));
