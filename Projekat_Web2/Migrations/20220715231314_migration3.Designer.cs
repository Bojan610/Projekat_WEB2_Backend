...
namespace Projekat_Web2.Migrations
{
    ...
    [Migration("20220715231314_migration3")]
            ...
            modelBuilder.Entity("Projekat_Web2.Models.Consumer", b =>
                {
                    ...
                    b.Property<int>("CurrentOrderID_Con")
                        .HasColumnType("int");

                    b.HasIndex("CurrentOrderID_Con")
                        .IsUnique()
                        .HasFilter("[CurrentOrderID_Con] IS NOT NULL");
            ...
            modelBuilder.Entity("Projekat_Web2.Models.Consumer", b =>
                {
                    b.HasOne("Projekat_Web2.Models.Order", "CurrentOrder_Con")
                        .WithOne("ConsumerCurrent")
                        .HasForeignKey("Projekat_Web2.Models.Consumer", "CurrentOrderID_Con")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
